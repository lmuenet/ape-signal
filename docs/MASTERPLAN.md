...
| 5 | **B4 Intraday-Opportunismus (Finding D)** | gestaffelt (Beschluss 2026-06-18): **Stufe 1** Limit-Leiter + TTL (jetzt, null LLM) → **Stufe 2** Setup-Radar (null LLM) → **Stufe 3** aktive Eröffnung gegated nach B1+B2 |
